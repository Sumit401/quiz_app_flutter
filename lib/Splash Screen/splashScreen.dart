                ...
                return AnimatedSplashScreen(
                  ...
                  splash: Column(
                    ...
                    children: [
                      Column(
                        children: [
                          Container(margin: const EdgeInsets.only(top: 50),height: 100,width: 100,child: CircularProgressIndicator(strokeWidth: 5,)),
                          Container(margin: EdgeInsets.only(top: 30),child: Text("Please Wait"),)
                        ],
                      ),
                      Container(
