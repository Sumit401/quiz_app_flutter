    ...
    builder: (context, proValue, child) {
      return ElevatedButton(onPressed: () {
            if (infoType == "User Name") {
              ...
              FirebaseAuth.instance.currentUser?.updateDisplayName(proValue.userName);
              FirebaseFirestore.instance.collection("users").doc(userInfo.email).update(updatedData);
            }
